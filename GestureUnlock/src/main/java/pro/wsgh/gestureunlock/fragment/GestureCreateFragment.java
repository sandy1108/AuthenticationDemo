...
import pro.wsgh.gestureunlock.JsConst;
import pro.wsgh.gestureunlock.util.GestureUtil;
import pro.wsgh.gestureunlock.util.ResourceUtil;
import pro.wsgh.gestureunlock.vo.ConfigGestureVO;
import pro.wsgh.gestureunlock.vo.ResultFailedVO;
import pro.wsgh.gestureunlock.vo.ResultVerifyVO;
import pro.wsgh.gestureunlock.widget.GestureContentView;
import pro.wsgh.gestureunlock.widget.GestureDrawLine;
import pro.wsgh.gestureunlock.widget.LockIndicator;
...
public class GestureCreateFragment extends GestureBaseFragment implements OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        try {
            ...
            mTextCancel = (TextView) view.findViewById(ResourceUtil
                    .getResIdID("plugin_uexGestureUnlock_text_cancel"));
            mTextReset = (TextView) view.findViewById(ResourceUtil
